...
FROM dim.location; --3,662***3,662***566===P--1,304***1,304***162


--dim.location is equivalent to dim.organizationlocation WHERE organizationtype = 0
...
WHERE organizationtype = 0                          --===P--1,302***1,302***161
