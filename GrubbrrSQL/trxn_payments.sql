...
add kioskid CHARACTER VARYING (50),
add paymentmethod CHARACTER VARYING (50),
add paymentintegrationlabel text,
add orderdateutc text,
add sysinserttime TIMESTAMP,
add paymentcardtype CHARACTER VARYING (50)
...
and tp.paymentcardtype <> ''
order by orderdateutc desc
limit 1000"fact"."transactionheader"
...
--and th.ordersessionid in ('NV5WQHZCDL4MCU0B','R90EA4UYI0MDMG0Y')
