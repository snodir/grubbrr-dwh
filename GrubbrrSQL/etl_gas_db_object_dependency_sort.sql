...
CALL etl.usp_sort_db_objects_by_dependency();

-- Table: etl.gas_db_object_dependency_sort

-- DROP TABLE IF EXISTS etl.gas_db_object_dependency_sort;

CREATE TABLE IF NOT EXISTS etl.gas_db_object_dependency_sort
(
...
ALTER TABLE IF EXISTS etl.gas_db_object_dependency_sort
    OWNER to citus;


-- PROCEDURE: etl.usp_sort_db_objects_by_dependency()

-- DROP PROCEDURE IF EXISTS etl.usp_sort_db_objects_by_dependency();

CREATE OR REPLACE PROCEDURE etl.usp_sort_db_objects_by_dependency(
	)
LANGUAGE 'plpgsql'
AS $BODY$
...
END;
$BODY$;
ALTER PROCEDURE etl.usp_sort_db_objects_by_dependency()
    OWNER TO citus;
