...
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(syscosmosts),1767225610) FROM fact.gem_failed_order_job_notifications),      sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.gem_failed_order_job_notifications' AND source = 'gem-Job';
...
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(gem_syscosmosts),1767225610) FROM fact.sent_surveys),                        sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.sent_surveys' AND source = 'gem';
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(gem_syscosmosts),1767225610) FROM fact.itemssurvey),                         sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.itemssurvey' AND source = 'gem';
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(syscosmosts),1767225610) FROM fact.occasionsurveydetail WHERE sourceid = 1), sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.occasionsurveydetail' AND source = 'nge';
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(syscosmosts),1767225610) FROM fact.occasionsurveydetail WHERE sourceid = 2), sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.occasionsurveydetail' AND source = 'gem';
UPDATE fact.watermarktable SET ts = (SELECT COALESCE(MAX(nge_syscosmosts),1767225610) FROM fact.itemssurvey),                         sysupdatetime = NOW() :: TIMESTAMP WHERE watermarktablename = 'fact.itemssurvey' AND source = 'nge';
